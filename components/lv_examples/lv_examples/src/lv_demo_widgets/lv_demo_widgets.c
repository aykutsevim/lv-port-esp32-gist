...
static void click_event_cb(lv_obj_t * obj, lv_event_t event)
{
...
void lv_app_widgets(void)
{
    ...
    lv_obj_set_event_cb(tv, click_event_cb);
}
...
void lv_demo_widgets(void)
{
    ...
    t1 = lv_tabview_add_tab(tv, "Coğüşiöç");
    t2 = lv_tabview_add_tab(tv, "ViĞÜŞİÖÇ");
